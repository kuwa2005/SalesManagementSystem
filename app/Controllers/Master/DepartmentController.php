...
<body>
    ...
    <main style="padding: 24px; max-width: 1200px; margin: 0 auto;">
        ...
        <div class="search-form">
            <form method="get" action="/SalesManagementSystem/master/department.php">
                <div class="form-row">
        ...
        <div class="table-container">
            <div class="table-header">
                <h2>部門一覧</h2>
                <a href="/SalesManagementSystem/master/department.php?action=create" class="btn btn-primary">新規登録</a>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="/SalesManagementSystem/master/department.php?action=edit&id=<?= $row['id'] ?>" class="btn btn-small btn-secondary">編集</a>
                            <form method="post" action="/SalesManagementSystem/master/department.php" style="display: inline;" onsubmit="return confirm('本当に削除しますか？');">
            ...
            <div class="pagination">
                <?php for ($p = 1; $p <= $departments['total_pages']; $p++): ?>
                    ...
                    <?php else: ?>
                        <a href="/SalesManagementSystem/master/department.php?page=<?= $p ?>&keyword=<?= urlencode($_GET['keyword'] ?? '') ?>"><?= $p ?></a>
                    <?php endif; ?>
                <?php endfor; ?>
            </div>
            <?php endif; ?>
        ...
        <div class="slip-form">
            ...
            <form method="post" action="/SalesManagementSystem/master/department.php">
                <?= Csrf::field() ?>
                ...
                <div style="text-align: center; margin-top: 24px;">
                    ...
                    <a href="/SalesManagementSystem/master/department.php" class="btn btn-secondary">一覧に戻る</a>
                </div>
            </form>
        </div>
        <?php endif; ?>
